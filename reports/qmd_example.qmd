...
![Horse populations for all provinces in Canada from 1906 - 1972.](../results/horse_pops_plot.png){#fig:horse_populations}


Figure 1: Horse populations for all provinces in Canada from 1906 - 1972.

We can see from [Figure @fig:horse_populations] that Ontario, Saskatchewan and Alberta 
...
We present the standard deviations in [Table @tab:horse_population_sd].

Table 1. Standard deviation of historical (1906-1972) horse populations for each Canadian province.

```{python, fig.cap="Standard deviation of historical (1906-1972) horse populations for each Canadian province."}
...
Additionally, note that in [Table @tab:horse_population_sd] we consider the sample standard deviation of the number of horses during the same time span as Figure 1.

![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig:largest_sd width=70%}
